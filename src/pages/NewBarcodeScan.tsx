...
function NewScanButton({navigation}: any) {
  return (
    <View style={styles.container}>
      <TouchableHighlight
        ...
        <View style={styles.buttonContainer}>
          ...
          <Text style={styles.text}>New Barcode Scanner</Text>
        </View>
      </TouchableHighlight>
    </View>
  );
...
function NewBarcodeScan() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Old Barcode Scan" component={NewScanButton} />
      <Stack.Screen
